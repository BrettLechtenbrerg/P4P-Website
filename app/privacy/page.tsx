...
export default function PrivacyPage() {
  const { header, effectiveDate, sections } = privacyContent;
                  ...
                  <section key={index}>
                    ...
                    {section.subsections && section.subsections.map((subsection, subIndex) => (
                      <div key={subIndex}>
                        ...
                        {subsection.content && (
                          <p className="text-white/70 leading-relaxed">{subsection.content}</p>
                        )}
                        {subsection.items && (
                    ...
                    {section.footer && (
                      <p className="text-white/70 leading-relaxed mt-4">{section.footer}</p>
                    )}
